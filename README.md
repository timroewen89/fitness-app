# Momentum Fitness Tracker 2.9

## Publiceren met GitHub Pages

1. Upload de inhoud van deze map naar de hoofdmap van je repository.
2. Open in GitHub **Settings → Pages**.
3. Kies **Deploy from a branch**, branch **main** en map **/(root)**.
4. Open het gepubliceerde adres in Safari op je iPhone.
5. Kies **Delen → Zet op beginscherm → Open als web-app**.
